...
func (_MulticallContract *MulticallContractTransactor) Aggregate(opts *bind.TransactOpts, calls []MulticallCall) (*types.Transaction, error) {
...
//
// Solidity: function aggregate((address,bytes)[] calls) returns(uint256 blockNumber, bytes[] returnData)
func (_MulticallContract *MulticallContractSession) Aggregate(calls []MulticallCall) (*types.Transaction, error) {
...
//
// Solidity: function aggregate((address,bytes)[] calls) returns(uint256 blockNumber, bytes[] returnData)
func (_MulticallContract *MulticallContractTransactorSession) Aggregate(calls []MulticallCall) (*types.Transaction, error) {
	return _MulticallContract.Contract.Aggregate(&_MulticallContract.TransactOpts, calls)
}
