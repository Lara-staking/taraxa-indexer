...
func MakeGenesis(s storage.Storage, c chain.Client, oracle *oracle.Oracle, gen_obj chain.GenesisObject, genesisHash storage.GenesisHash, accounts *storage.AccountsMap) *Genesis {
	var genesis Genesis
	genesis.storage = s
